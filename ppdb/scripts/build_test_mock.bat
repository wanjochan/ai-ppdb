...
rem Build platform mock
echo Building platform mock...
"%GCC%" %CFLAGS% -I"%SRC_DIR%" -I"%TEST_DIR%" -I"%TEST_DIR%\white" "%PPDB_DIR%\test\white\infra\mock_platform.c" -c -o "%BUILD_DIR%\test\white\infra\mock_platform.o"
if errorlevel 1 exit /b 1
...
"%GCC%" %CFLAGS% -I"%SRC_DIR%" -I"%TEST_DIR%" -I"%TEST_DIR%\white" "%PPDB_DIR%\test\white\infra\test_platform_mock.c" -c -o "%BUILD_DIR%\test\white\infra\test_platform_mock.o"
if errorlevel 1 exit /b 1

rem Link test executables
echo Linking test executables...
"%GCC%" %LDFLAGS% "%BUILD_DIR%\test\white\infra\test_memory_mock.o" "%BUILD_DIR%\test\white\framework\test_framework.o" "%BUILD_DIR%\test\white\framework\mock_framework.o" "%BUILD_DIR%\test\white\infra\mock_memory.o" "%BUILD_DIR%\infra\libinfra.a" %LIBS% -o "%BUILD_DIR%\test\white\infra\test_memory_mock.exe"
if errorlevel 1 exit /b 1

"%GCC%" %LDFLAGS% "%BUILD_DIR%\test\white\infra\test_platform_mock.o" "%BUILD_DIR%\test\white\framework\test_framework.o" "%BUILD_DIR%\test\white\framework\mock_framework.o" "%BUILD_DIR%\test\white\infra\mock_platform.o" "%BUILD_DIR%\infra\libinfra.a" %LIBS% -o "%BUILD_DIR%\test\white\infra\test_platform_mock.exe"
if errorlevel 1 exit /b 1
