...
rem Build AST3
echo Building AST3...
"%GCC%" %CFLAGS% "%SRC_DIR%\ast3.c" %LDFLAGS% %LIBS% -o "%BUILD_DIR%\ast3.exe.dbg"
if errorlevel 1 exit /b 1

"%OBJCOPY%" -S -O binary "%BUILD_DIR%\ast3.exe.dbg" "%BUILD_DIR%\ast3.exe"
if errorlevel 1 exit /b 1
