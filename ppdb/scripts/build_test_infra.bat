...
set TEST_FILES=test_memory.c test_log.c test_sync.c test_async.c test_error.c test_metrics.c test_skiplist.c test_struct.c test_peer.c test_memtable.c
