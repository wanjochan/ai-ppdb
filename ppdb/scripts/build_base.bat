...
%GCC% %CFLAGS% "%PPDB_DIR%\src\base.c" "%PPDB_DIR%\test\white\infra\test_sync.c" %LDFLAGS% %LIBS% -o "%BUILD_DIR%\sync_test.exe.dbg"
if errorlevel 1 exit /b 1
...
%GCC% %CFLAGS% "%PPDB_DIR%\src\base.c" "%PPDB_DIR%\test\white\infra\test_skiplist.c" %LDFLAGS% %LIBS% -o "%BUILD_DIR%\skiplist_test.exe.dbg"
if errorlevel 1 exit /b 1
