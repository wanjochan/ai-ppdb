...
set CFLAGS=-g -O2 -Wall -Wextra -fno-pie -fno-stack-protector -fno-omit-frame-pointer -mno-red-zone -fno-common -fno-plt -fno-asynchronous-unwind-tables -include %COSMO%\cosmopolitan.h
...
%GCC% %LDFLAGS% -o ppdb.exe.dbg main.o libppdb.a %LIBS%

rem Process with objcopy for cosmopolitan format
echo Processing for cosmopolitan format...
"%CROSS9%\x86_64-pc-linux-gnu-objcopy.exe" -S -O binary ppdb.exe.dbg ppdb.exe
