...
class TestMemKVProtocol(unittest.TestCase):
    ...
    def setUpClass(cls):
        # 启动 memkv 服务
        exe_path = os.path.join(os.path.dirname(__file__), "../../../ppdb_latest.exe")
        cls.memkv_process = subprocess.Popen(
            [exe_path, "memkv", "--start", "--port=11211"],
    ...
    def tearDownClass(cls):
        cls.client.close()
        cls.memkv_process.terminate()
        cls.memkv_process.wait()
