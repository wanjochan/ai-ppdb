...
ppdb_error_t ppdb_memkv_put(ppdb_base_t* base, const ppdb_key_t* key, const ppdb_value_t* value);
ppdb_error_t ppdb_memkv_delete(ppdb_base_t* base, const ppdb_key_t* key);

// 批量操作
ppdb_memkv_batch_t* ppdb_memkv_batch_create(ppdb_base_t* base);
void ppdb_memkv_batch_destroy(ppdb_memkv_batch_t* batch);
ppdb_error_t ppdb_memkv_batch_put(ppdb_memkv_batch_t* batch, const ppdb_key_t* key, const ppdb_value_t* value);
ppdb_error_t ppdb_memkv_batch_delete(ppdb_memkv_batch_t* batch, const ppdb_key_t* key);
ppdb_error_t ppdb_memkv_batch_commit(ppdb_memkv_batch_t* batch);
...
ppdb_error_t ppdb_memkv_snapshot_get(ppdb_memkv_snapshot_t* snapshot, const ppdb_key_t* key, ppdb_value_t* value);
...
// 维护操作
ppdb_error_t ppdb_memkv_compact(ppdb_base_t* base);
ppdb_error_t ppdb_memkv_clear(ppdb_base_t* base);
