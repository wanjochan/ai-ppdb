...
// 读锁
void ppdb_sync_read_lock(ppdb_sync_t* sync);

// 写锁
void ppdb_sync_write_lock(ppdb_sync_t* sync);

// 解读锁
void ppdb_sync_read_unlock(ppdb_sync_t* sync);

// 解写锁
void ppdb_sync_write_unlock(ppdb_sync_t* sync);
