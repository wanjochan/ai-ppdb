...
REM Set build flags
set COMMON_FLAGS=-g -Os -Wall -fno-pie -no-pie -mno-red-zone -fno-omit-frame-pointer -nostdlib -nostdinc -DCONFIG_COSMO=1
set WARNING_FLAGS=-Wno-sign-compare -Wno-unused-parameter -Wno-unused-function -Wno-unused-variable
set INCLUDE_FLAGS=-I"%COSMO_DIR%" -I"%TCC_DIR%" -I"%LAB_DIR%" -I"%COSMO_DIR%\libc\nexgen32e" -I"%COSMO_DIR%\libc\isystem"
set CFLAGS=%COMMON_FLAGS% %WARNING_FLAGS% %INCLUDE_FLAGS% -ffunction-sections -fdata-sections -include "%COSMO_DIR%\cosmopolitan.h"
